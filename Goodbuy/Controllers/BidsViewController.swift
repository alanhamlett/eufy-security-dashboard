...
class BidsViewController: UIViewController, UIGestureRecognizerDelegate {
    fileprivate var keyboardState: KeyboardState?
    fileprivate var bottomConstraint: Constraint!
    
    fileprivate lazy var titleBar: TitleBarView = {
        let view = TitleBarView(title: "Bids", subTitle: nil)
...
extension BidsViewController: TitleBarViewDelegate {
    func tappedBack() {
...
extension BidsViewController: KeyboardHelperDelegate {
